...
public class FlickrFetchr {
    ...
    private static final Uri ENDPOINT = Uri.parse("https://api.flickr.com/services/rest/")
            ...
            .appendQueryParameter(Parameter.EXTRAS, URL_S + ",geo")
            .build();
    ...
    private String buildUrl(Location location) {
        return ENDPOINT.buildUpon()
                .appendQueryParameter(Parameter.METHOD, Method.SEARCH)
                .appendQueryParameter(Parameter.LAT, "" + location.getLatitude())
                .appendQueryParameter(Parameter.LON, "" + location.getLongitude())
                .build().toString();
    }
